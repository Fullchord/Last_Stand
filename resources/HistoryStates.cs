...
namespace history {
    ...
    class HistoryStates {
        static void Main(string[] args) {
            ...
            string[] tags = new String[44] {observer,"ALB","AST","AUS","BEL","BRA","BUL","CAN","CHI","CZE","DEN","ENG","EST","FIN","FRA","GER","GRE","HOL","HUN","IRE","IRQ","ITA","JAP","LAT","LIT","LUX","MAN","MEX","NOR","NZL","POL","RAJ","ROM","SAF","SIA","SOV","SPR","USA","VEN","VIC","YUG","ETH","PER","PHI"};
