...
NDefines.NProduction.LICENSE_EQUIPMENT_SPEED_NOT_FACTION = -0.00	
NDefines.NDiplomacy.LICENSE_ACCEPTANCE_OPINION_FACTOR = 0
NDefines.NDiplomacy.LICENSE_ACCEPTANCE_TECH_DIFFERENCE = 12			     	    

NDefines_CareerProfile.NCareerProfile.MOD_STATISTICS_GROUP = "Grapemod"
NDefines_CareerProfile.NCareerProfile.MOD_STATISTICS_GROUP_NAME = "Grapemod"
...
NDefines.NNavy.NAVAL_SUPREMACY_CAN_INVADE = 0.35
